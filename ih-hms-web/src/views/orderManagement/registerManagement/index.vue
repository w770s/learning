    ...
    <el-card style="margin-top: 5px">
      <el-form class="fromAll" :inline="true">
        ...
        >
          ...
          >
            <template slot-scope="scope">{{
              scope.row.regFee !== null ? scope.row.regFee / 100 : "---"
            }}</template>
          </el-table-column>
...
<script>
import { apiRegisterOrderList, apiSyncHisStatus } from "@/api/orderManagement";
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      const params = {
        ...
        status: this.orderStatus !== undefined ? this.orderStatus : "",
