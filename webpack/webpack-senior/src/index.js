...
//             }).catch(err=>{console.log('service not-working')})
//     })
// }
// 10. PWA 打包配置
//（1）http-server
// (2) 在 package.json scripts 配置 http-server dist 开启一个服务器 资源是dist 目录 在dist 目录下开启一个http-server
// (3) 下载 workbox-webpack-plugin
// (4) prod.js 配置文件 配置
...
// import Child from 'linan' // 要像导入 第三方模块一样的导入 ，可以配置一个 别名
// import _ from 'lodash'
// class App extends Component{
//     render() {
//         return (
//             <div>
//                 <div>{_.join(['1','2','3'],'-')}</div>
//             </div>
//         )
//     }
// }
