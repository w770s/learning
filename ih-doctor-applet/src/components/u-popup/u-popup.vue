...
<!--					:size="closeIconSize"-->
<!--				></u-icon>-->
				<img v-if="closeable" :style="{width:'28rpx',height:'28rpx',size:closeIconSize}" src="http://file.aihuihc.com/ih-doctor-applet/image/home/forthVersion/cancelicon.png" @click="close"/>
...
<!--			<scroll-view class="u-drawer__scroll-view" scroll-y="true" v-else>-->
			<slot v-else />
<!--			</scroll-view>-->
			<view @tap="close" v-if="isShowCancel" class="u-close" :class="['u-close--' + closeIconPos]">
				<img v-if="mode != 'center' && closeable" style="width:28rpx;height:28rpx;" src="http://file.aihuihc.com/ih-doctor-applet/image/home/forthVersion/cancelicon.png"/>
			</view>
		</view>
	</view>
</template>
...
export default {
	...
	computed: {
		...
		centerStyle() {
			...
			style.zIndex = this.uZindex;
			style.marginTop = `-${this.negativeTop}rpx`;
			if (this.borderRadius) {
