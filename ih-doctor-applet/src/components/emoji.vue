                    ...
                    <view style='display: inline-block;'
                        ...
                        <swiper-item>
                            <view class='emoji-content-item'
                                ...
                                <img v-if="emojiList[currentAlbum][currentEmojiKey].img" :src="emojiList[currentAlbum][currentEmojiKey].img"
    ...
    export default {
        ...
        methods: {
            ...
            switchAlbum(album) {
                ...
                this.currentAlbumKeys = currentAlbumKeys
                console.log(currentAlbumKeys,currentAlbum,this.emojiList);
            },
            /**
             * 每页显示固定个数
