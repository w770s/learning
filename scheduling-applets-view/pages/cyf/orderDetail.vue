	...
	<view class="content">
		<form>
			...
			<view class="uni-btn-v" v-if="specialStatus==='待接单'">
				<button class="big-blue" @tap="ChangeOrderBill('接受')">接受</button>
				<button class="big-orange" @tap="ChangeOrderBill('拒绝')">拒绝</button>
			</view>
		</form>
	</view>
</template>
	...
	export default {
		...
		methods: {
			ChangeOrderBill(value) {
				...
				this.apiChangeOrderStatus(data)
			},
			apiChangeOrderStatus(data){
