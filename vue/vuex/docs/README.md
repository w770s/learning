...
Let's start with a simple Vue counter index:
...
It is a self-contained index with the following parts:

- The **state**, the source of truth that drives our index;
