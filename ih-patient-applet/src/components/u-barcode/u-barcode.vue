<template xlang="wxml" minapp="mpvue">
	<view class="tki-barcode">
		...
		<!-- #endif -->
		<image v-show="show" :src="result" :style="{height:canvasHeight+'px',width:'100%'}" />
	</view>
</template>
