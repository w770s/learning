<template>
	<view v-if="loading" :style="{
	 ...
	 @touchmove.stop.prevent>
		<view v-for="(item, index) in RectNodes" :key="index" :class="[animation ? 'skeleton-fade' : '']" :style="{
			width: item.width + 'px',
		...
		<view v-for="(item, index) in circleNodes" :key="index" :class="animation ? 'skeleton-fade' : ''" :style="{
			width: item.width + 'px',
			height: item.height + 'px',
			backgroundColor: elColor,
		...
		<view v-for="(item, index) in filletNodes" :key="index" :class="animation ? 'skeleton-fade' : ''" :style="{
			width: item.width + 'px',
			height: item.height + 'px',
			backgroundColor: elColor,
