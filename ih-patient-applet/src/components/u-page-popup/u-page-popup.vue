	...
	<view v-if="visibleSync" :style="[customStyle, {
		...
		>
			<view class="u-mode-center-box" @tap.stop.prevent @touchmove.stop.prevent v-if="mode == 'center'" :style="[centerStyle]">
				<img v-if="closeable"
					 @click="close"
					 style="width:30rpx;height:30rpx;position: absolute;z-index: 3;"
					 :class="['u-close--' + closeIconPos]"
					 src="http://file.aihuihc.com/patient/patientImages/images/login/arrow-right-double.png"
				/>
			...
			<view @tap="close" class="u-close" :class="['u-close--' + closeIconPos]">
				<img v-if="mode != 'center' && closeable"
					 style="width:30rpx;height:30rpx;"
					 src="http://file.aihuihc.com/patient/patientImages/images/login/close-down.png"
				/>
			</view>
		</view>
	</view>
 ...
 * @example <u-page-popup v-model="show"><view>出淤泥而不染，濯清涟而不妖</view></u-page-popup>
 */
export default {
	name: 'u-popup',
	props: {
